...
const Form = props=>{
    ...
    const onSubmit = ()=>{
        ...
        submitData.parentId = get(props,'data._id');
        submitData.parentPosition = get(props,'data.position');
        console.log('submitData', submitData);
        axios.post(MENU.create,submitData)
        .then(result=>{
    ...
    return (
        <div className="form-content">
            ...
            <div className="row mb-4">
                ...
                <div className="col-md-6 mb-2">
                <TextField  value={get(props,'data.name') || 'Root'} disabled  fullWidth id="user-form-parent-field" label="Parent" />
                </div>
            </div>
